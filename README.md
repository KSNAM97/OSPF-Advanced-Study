...
![Topology](https://www.genspark.ai/api/files/s/E1xki8cQ)
![Topology2](https://www.genspark.ai/api/files/s/rFIA91FH)
...
- **R1, R3** : ABR (Area 0 ↔ Area 14 / Area 0 ↔ EIGRP)
- **R3** : ASBR (OSPF ↔ EIGRP 재분배)
- **R2** : Frame-Relay Hub (DR 역할)
